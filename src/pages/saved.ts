...
<nav class="fixed left-0 top-0 h-full w-72 flex flex-col pt-20 pb-8 px-6 space-y-4 bg-surface-container-low border-r border-surface-container-highest z-40 hidden md:flex transition-all duration-300">
  ...
  <div class="flex-1 space-y-2">
    ...
    <a class="flex items-center space-x-3 text-primary font-bold border-r-4 border-primary pl-4 py-3 bg-surface-container-high rounded-l-lg transition-all duration-300" href="/saved" data-link>
      <span class="material-symbols-outlined fill-icon text-xl" data-icon="bookmark">bookmark</span>
...
<main class="flex-1 ml-0 md:ml-72 min-h-screen bg-surface flex flex-col lg:flex-row relative">
  ...
  <div class="md:hidden sticky top-0 bg-surface/80 backdrop-blur-md z-30 px-6 py-4 flex justify-between items-center border-b border-surface-container-low">
    <h1 class="font-headline font-bold text-lg text-primary">Saved Resources</h1>
  ...
  <div class="flex-1 px-6 md:px-12 lg:px-16 py-8 md:py-12 max-w-5xl overflow-y-auto w-full">
    ...
    <header class="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
      <div>
        <h2 class="font-headline text-4xl md:text-5xl font-extrabold text-on-background tracking-tight mb-2">Your Saved Resources</h2>
      ...
      <div class="relative w-full md:w-80 group">
        ...
        <input id="saved-search-input" class="w-full bg-surface-container-low border-none rounded-full py-3.5 pl-12 pr-4 text-sm font-body text-on-surface placeholder:text-outline focus:ring-2 focus:ring-primary/20 transition-shadow" placeholder="Search your archives..." type="text"/>
      </div>
    </header>
